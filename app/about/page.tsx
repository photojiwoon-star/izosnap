 ...
 return (
   <main className="min-h-screen bg-white text-black px-6 py-12 md:p-10">
     ...
     <div className="text-base md:text-lg leading-relaxed max-w-2xl space-y-4">
      ...
      <p>
       서울이면 어디든 손님이 원하는 장소에서 원하는 의상으로 찍습니다. <br />
       대학 캠퍼스, 경복궁, 벚꽃시즌 석촌호수 등 개방된 곳이라면 어디든 갑니다.<br />
       가운을 입으면 졸업스냅이 되고, 애인을 데려오면 커플스냅이 됩니다.
      </p>

      <p>
       다만 이졸드 스냅은 몇 개월 후 폐업합니다. <br/>
       (작가 체력 및 수험 이슈..) <br />
       촬영을 원하신다면 빠른 예약 부탁드립니다.
      </p>
      ...
      <p>
       다행히도 대부분은 촬영 결과물에 크게 만족해 주십니다. <br />
       최선을 다하겠습니다.
      </p>
